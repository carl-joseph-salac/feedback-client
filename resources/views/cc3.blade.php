            ...
            <div class="px-4">
                ...
                <form action="{{ route('sqd0') }}" method="post" class="mt-2">
                    ...
                    <table >
                        ...
                        <tr>
                            <td></td>
                            <td ><input class="checkboxes" type="checkbox" name="cc3Choices1" id="cc3Choices1"
                                value="{{$cc->choices1}}" {{ session('cc3Choices1') ? 'checked' : '' }}></td>
                            <td colspan="2">1.  {{$cc->choices1}}</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td ><input class="checkboxes" type="checkbox" name="cc3Choices2" id="cc3Choices2"
                                value="{{$cc->choices2}}" {{ session('cc3Choices2') ? 'checked' : '' }}></td>
                            <td colspan="2">2. {{$cc->choices2}} </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td ><input class="checkboxes" type="checkbox" name="cc3Choices3" id="cc3Choices3"
                                value="{{$cc->choices3}}" {{ session('cc3Choices3') ? 'checked' : '' }}></td>
                            <td colspan="2">3. {{$cc->choices3}} </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td ><input class="checkboxes" type="checkbox" name="cc3Choices4" id="cc3Choices4"
                                value="{{$cc->choices4}}" {{ session('cc3Choices4') ? 'checked' : '' }}></td>
