            ...
            <div class="px-4">
                ...
                <form action="{{ route('sqd0') }}" method="post" class="mt-2">
                    ...
                    <table >
                        ...
                        <tr>
                            <td></td>
                            <td ><input class="checkboxes" type="radio" name="cc3" value="{{$cc->choices1}}"
                                {{ session('cc3') == $cc->choices1 ? 'checked' : '' }}></td>
                            <td colspan="2">1.  {{$cc->choices1}}</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td ><input class="checkboxes" type="radio" name="cc3" value="{{$cc->choices2}}"
                                {{ session('cc3') == $cc->choices2 ? 'checked' : '' }}></td>
                            <td colspan="2">2. {{$cc->choices2}} </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td ><input class="checkboxes" type="radio" name="cc3" value="{{$cc->choices3}}"
                                {{ session('cc3') == $cc->choices3 ? 'checked' : '' }}></td>
                            <td colspan="2">3. {{$cc->choices3}} </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td ><input class="checkboxes" type="radio" name="cc3" value="{{$cc->choices4}}"
                                {{ session('cc3') == $cc->choices4 ? 'checked' : '' }}></td>
