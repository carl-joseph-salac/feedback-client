        ...
        <div class="container mb-3 mt-0">
            <div class="container border">
                <div class="px-4">
                    ...
                    <form action="{{ route('sqd7') }}" method="post">
                        @csrf
                        @method('post')
                        <p>
                            ...
                            <div class="rating-wrap">
                                <div class="center text-center">
                                    <fieldset class="rating">
                                        ...
                                        <h6 id="rating-value">{{ session('sqd6ChosenRating') }}</h6>
                                    </fieldset>
                                </div>
                            </div>
                        </div>
                        <div class="container text-center d-flex justify-content-center my-3">
                            <a href="{{ route('sqd5Star') }}" class="text-center btn btn-success rounded-1 prev mr-2">Back</a>
