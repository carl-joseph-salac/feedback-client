            ...
            <div class="col-lg-9 col-md-10">
                <div class="card b-0 rounded-0 show">
                    ...
                    <div class="p-3 justify-content-center text-center">
                        ...
                        <button name="next" id="next1" class="btn btn-success rounded-0 mb-5 next">START</button>
                    </div>
                </div>
                ...
                <div class="card b-0 rounded-0">
                    ...
                    <div class="p-3 justify-content-center text-center">
                        ...
                        <button class="btn btn-success rounded-0 mb-5 prev">Back</button>
                        <button id="next2" class="btn btn-success rounded-0 mb-5 next" onclick="validate(0)">Submit</button>
                    </div>
                </div>
